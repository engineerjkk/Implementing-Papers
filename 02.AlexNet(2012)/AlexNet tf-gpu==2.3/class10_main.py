...
#class10_main, class10_model, optimizer_alexnet 세개만 봐도 된다.
# BN_refer은 Batch Normalization을 구현, gen_imgNet은 프로토콜버퍼로 변환, IrnVSbn은 Irn과 BatchNomarlization 비교이다. Irn은 main에 있다.
